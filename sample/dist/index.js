...
/* harmony import */ var _src_hub__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
console.log('Split', 1);
var hub = new _src_hub__WEBPACK_IMPORTED_MODULE_0__["default"]({
  foo: 'bar',
  boo: {
    jar: {
      inner: 'yeah'
...
function todos() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initTodo;
...
_defineProperty(ModuleA, "module", 'modulea');

_defineProperty(ModuleA, "reducers", todos);
...
_defineProperty(ModuleB, "module", 'moduleb');

_defineProperty(ModuleB, "reducers", counter);

var registrar = function registrar(ins) {
  ins.addModule(ModuleA);
  ins.addModule(ModuleB);
  ins.addAsyncModule(function () {
    return __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 37));
  }, 'foo');
};

hub.start(function (ins) {
  setTimeout(function () {
    ins.init(function (rootReducer, initialState) {
      return Object(redux__WEBPACK_IMPORTED_MODULE_1__["createStore"])(rootReducer, initialState);
    }).then(function () {
      console.log('isReady', hub.isReady); // console.log('state', hub.getter.getStore())
    });
  }, 1000);
}, registrar); // hub.getAsyncModule('foo', this)
// const Foo = hub.getAsyncModule('foo', this)
// Foo.isLoaded // Check if loaded or not
// Foo.Loading // Loading component
// Foo.View // Component is render method
// Foo.onLoad.then(foo => this.foo = foo)
...
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
...
/* harmony import */ var lodash_pick__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
...
/* harmony import */ var lodash_isempty__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var lodash_isempty__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_isempty__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _getter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _setter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19);
...
var prefix = '__HUB__:';
var HubContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext({});

var ReactModuleHub =
/*#__PURE__*/
function () {
  function ReactModuleHub() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, ReactModuleHub);

    this.isReady = false;
    this.getter = new _getter__WEBPACK_IMPORTED_MODULE_6__["default"](this);
    this.setter = new _setter__WEBPACK_IMPORTED_MODULE_7__["default"](this);
    this._options = options;
    this._config = null;
    this._store = null;
    this._modules = {};
    this._instances = {}; // Holds the root reducer (will be cleared when init is done)
    // Init method should consume it for creating the store

    this._reducers = null; // Promises returned by start lifecycle (will be cleared)

    this._startups = []; // Immediate async imports returned by registrar (will be cleared)
  ...
  _createClass(ReactModuleHub, [{
    ...
    value: function start(setup, registrar) {
      ...
      if (!lodash_isempty__WEBPACK_IMPORTED_MODULE_5___default()(reducers)) this._reducers = Object(redux__WEBPACK_IMPORTED_MODULE_1__["combineReducers"])(reducers); // Call component setup from user
    ...
    key: "init",
    value: function init(createStore) {
      var _this = this;

      return this._getInitialState().then(function (initState) {
        if (createStore && _this._reducers) {
          var store = createStore(_this._reducers, initState);
    ...
    value: function getConfig(pathKey, defaultValue) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this._config, pathKey, defaultValue);
    }
  }, {
          ...
          if (mod.persist && storage) {
            ...
            if (mod.persist === true) {
              storage.getItem(prefix + mod.module).then(function (value) {
                return lodash_set__WEBPACK_IMPORTED_MODULE_3___default()(state, mod.module, JSON.parse(value || '{}'));
              ...
              mod.persist.forEach(function (path) {
                ...
                promises.push(storage.getItem(prefix + path).then(function (value) {
                  try {
                    lodash_set__WEBPACK_IMPORTED_MODULE_3___default()(state, path, JSON.parse(value));
    ...
    value: function _persistState(path) {
      ...
      var handleChange = function handleChange() {
        var currentState = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(_this4._store.getState(), path);
  ...
  return ReactModuleHub;
}();

ReactModuleHub.withModules = function (ChildComponent) {
    ...
    function (_React$Component) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(HubContext.Consumer, null, function (hub) {
            var store = hub.getter.getStore();
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ChildComponent, _objectSpread({
              hub: hub.getter,
              modules: hub.getter._getModules(modules),
              state: store && lodash_pick__WEBPACK_IMPORTED_MODULE_4___default()(store.getState(), modules)
            }, _this5.props));
          });
        }
      }]);
...
ReactModuleHub.withRequiredModules = function (ChildComponent) {
...
/* harmony default export */ __webpack_exports__["default"] = (ReactModuleHub);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* global window */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(events__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_reduce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18);
...
function (_EventEmitter) {
  ...
  _createClass(ModuleGetter, [{
    ...
    value: function getModule(name) {
      var module = this._hub._modules[name.toLowerCase()];
    ...
    key: "getAsyncModule",
    value: function getAsyncModule(name) {
      var module = this._hub._modules[name.toLowerCase()];

      if (!module) return Promise.resolve(null);
      return this._instantiateAsyncModule(module, name);
    }
  }, {
    key: "getRequiredAsyncModule",
    value: function getRequiredAsyncModule(name) {
      var module = this._hub._modules[name.toLowerCase()];

      if (!module) return Promise.reject(new Error("Module \"".concat(name, "\" not found")));
      return this._instantiateAsyncModule(module, name);
    }
  }, {
    key: "_instantiateModule",
    value: function _instantiateModule(Module, name, forceSingleton) {
      var instances = this._hub._instances;

      var config = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this._hub._config.modules, name);
    ...
    key: "_instantiateAsyncModule",
    value: function _instantiateAsyncModule(module, name) {
      var _this2 = this;

      return module().then(function (RealModule) {
        return _this2._instantiateModule(RealModule, name, module.isSingleton);
      });
    }
  }, {
    key: "_getModules",
    value: function _getModules(names) {
      ...
      return lodash_reduce__WEBPACK_IMPORTED_MODULE_1___default()(names, function (o, k) {
        o[k] = _this3.getModule(k);
        return o;
      }, {});
    }
  }, {
    ...
    value: function _getRequiredModules(names) {
      ...
      return lodash_reduce__WEBPACK_IMPORTED_MODULE_1___default()(names, function (o, k) {
        o[k] = _this4.getRequiredModule(k);
        return o;
      }, {});
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (ModuleGetter);
...
function () {
  ...
  _createClass(ModuleSetter, [{
    ...
    value: function addScopeModule(module, name) {
      ...
      if (this._hub._modules[name]) throw new Error("Module \"".concat(name, "\" already registered"));
    ...
    value: function addScopeAsyncModule(module, name) {
      ...
      module.isAsync = true;
      this._hub._modules[name.toLowerCase()] = module;
    }
  }, {
    key: "addAsyncModule",
...
/* harmony default export */ __webpack_exports__["default"] = (ModuleSetter);
...
(function() {
  ...
  writeSync = __webpack_require__(23).sync;
...
var chain = __webpack_require__(32).chain
var MurmurHash3 = __webpack_require__(36)
...
exports.bindActor = __webpack_require__(34)
...
var bindActor = __webpack_require__(34)
